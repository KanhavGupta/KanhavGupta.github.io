...
#             return np.concatenate((images_rest_part, images_new_part)), np.concatenate(
...
# def input_data(train_dir, dtype=dtypes.float32, reshape=True):
#     training_size = 28709
...
#     validation = DataSet(validation_faces, validation_emotions, dtype=dtype, reshape=reshape)
