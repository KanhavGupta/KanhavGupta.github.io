...
def format_image(image, vid=False):
    ...
    # None is when no face found in image
    if not len(faces) > 0:
        return None, None
    images = []
            ...
            if height*width == 2304:
                ...
                if detected_faces is not None:
                    ...
                    for i, face_coor in enumerate(face_coors):
                        ...
                        cv2.putText(
                            image1, emotions[i], (x1, y1), cv2.FONT_HERSHEY_PLAIN, h1//40, (0, 255, 0), w1//100)
                        try:
